        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/get-involved" className="text-gray-300 hover:text-blue-400 transition-colors">
                  Get Involved
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/reports" className="text-gray-300 hover:text-blue-400 transition-colors">
                  Annual Reports
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-300">P. O Box, 45, East Legon, Ghana</span>
              </li>
              <li className="flex items-center">
                <Phone className="h-5 w-5 text-blue-400 mr-2" />
                <span className="text-gray-300">+233597399216</span>
              </li>
              <li className="flex items-center">
                <Mail className="h-5 w-5 text-blue-400 mr-2" />
                <span className="text-gray-300">betterdreamfoundationghana@gmail.com</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">Subscribe to our newsletter for updates on our work and impact.</p>
