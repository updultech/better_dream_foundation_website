              ...
              <div className="space-y-6">
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="text-sm">Planned Giving</span>
                      </div>
                      <div className="flex items-center">
                        <Heart className="h-4 w-4 text-gray-400 mr-2" />
                        <span className="text-sm">Memorial Gifts</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card>
                  <CardContent className="p-6">
                    ...
                    <p className="text-sm font-medium">donations@betterdreamfoundation.org</p>
