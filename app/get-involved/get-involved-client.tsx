...
import { Heart, Users, DollarSign, Calendar, Globe, Handshake, ArrowRight, AlertCircle, CheckCircle } from "lucide-react"
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      {success && (
        <div className="flex items-center gap-3 p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
          ...
          <p className="text-green-800 dark:text-green-200">Application submitted successfully! We'll be in touch soon.</p>
        </div>
      )}
